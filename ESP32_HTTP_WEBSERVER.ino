...
#define gpio16LEDPin 0 /* One LED connected to GPIO16 - RX2 */
#define gpio17LEDPin 1 /* One LED connected to GPIO17 - TX2 */

const char* ssid = "Raju"; /* Add your router's SSID */
const char* password = "thekingsuv1901"; /*Add the password */
